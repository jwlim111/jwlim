...
b_tx_button = ttk.Button(measurement, text='ch1_capture_tx_1 ', width = 30, command=ch1_capture_tx_1)
b_tx_button.grid(column=0, row=1, pady= 10)
b_rx_button = ttk.Button(measurement, text='ch1_gen_1 ', width = 30, command=ch1_gen_1)
b_rx_button.grid(column=1, row=1)

b_tx_button = ttk.Button(measurement, text='ch1_capture_tx_2 ', width = 30, command=ch1_capture_tx_2)
b_tx_button.grid(column=0, row=2, pady= 10)
b_rx_button = ttk.Button(measurement, text='ch1_gen_2 ', width = 30, command=ch1_gen_2)
b_rx_button.grid(column=1, row=2)
