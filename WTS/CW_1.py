...
b_tx_button = ttk.Button(measurement, text='ch1_capture_tx Setting', width = 30, command=ch1_capture_tx)
b_tx_button.grid(column=0, row=1, pady= 10)
b_rx_button = ttk.Button(measurement, text='ch1_gen Per Measurement', width = 30, command=ch1_gen)
